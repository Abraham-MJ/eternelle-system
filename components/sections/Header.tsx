        ...
        <nav className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <ul className="hidden lg:flex items-center gap-8 text-white text-sm">
              <li><a href="#about" className="hover:text-gray-300 transition">{t.nav.about}</a></li>
              <li><a href="#products" className="hover:text-gray-300 transition">{t.nav.products}</a></li>
              <li><a href="#business" className="hover:text-gray-300 transition">{t.nav.business}</a></li>
              <li><a href="#tech" className="hover:text-gray-300 transition">{t.nav.partners}</a></li>
              <li><a href="#contact" className="hover:text-gray-300 transition">{t.nav.contact}</a></li>
            </ul>
            ...
            <div className="hidden lg:flex items-center gap-4">
                ...
                {languages.map((lang) => (
                  <button
                    ...
                    className={`px-2 py-1 text-xs font-medium transition ${
                      locale === lang.code ? 'text-white' : 'text-gray-400 hover:text-white'
                    }`}
                  >
                    {lang.label}
                  </button>
              ...
              <div className="flex items-center gap-3">
                <a href="https://wa.me/593994107494" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#25D366] flex items-center justify-center hover:opacity-80 transition" aria-label={t.footer.ariaWhatsApp}>
                ...
                <a href="https://t.me/ronaldpokero" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#0088cc] flex items-center justify-center hover:opacity-80 transition" aria-label={t.footer.ariaTelegram}>
                ...
                <a href="mailto:rggamingsolutions@gmail.com" className="w-10 h-10 rounded-full bg-gray-700 flex items-center justify-center hover:opacity-80 transition" aria-label={t.footer.ariaEmail}>
            ...
            <button 
              ...
              aria-label={t.footer.ariaOpenMenu}
        ...
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div className={`absolute right-0 top-0 h-full w-80 bg-[#1a1a1a] p-6 overflow-y-auto transition-transform duration-300 ${isAnimating ? 'translate-x-0' : 'translate-x-full'}`}>
            ...
            <ul className="space-y-6 mb-8 text-white">
              <li><a href="#about" className="block text-lg" onClick={closeMenu}>{t.nav.about}</a></li>
              <li><a href="#products" className="block text-lg" onClick={closeMenu}>{t.nav.products}</a></li>
              <li><a href="#business" className="block text-lg" onClick={closeMenu}>{t.nav.business}</a></li>
              <li><a href="#tech" className="block text-lg" onClick={closeMenu}>{t.nav.partners}</a></li>
              <li><a href="#contact" className="block text-lg" onClick={closeMenu}>{t.nav.contact}</a></li>
            </ul>
              ...
              {languages.map((lang) => (
                <button
                  ...
                  className={`px-3 py-1.5 text-sm font-medium rounded transition ${
                    locale === lang.code ? 'bg-white text-black' : 'bg-white/10 text-white hover:bg-white/20'
                  }`}
                >
                  {lang.label}
                </button>
