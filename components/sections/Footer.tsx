    ...
    <footer className="bg-[#0a0d1a] border-t border-white/10 py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#hero" className="text-gray-400 hover:text-[#5b7cff] transition-colors">{t.footer.home}</a></li>
              <li><a href="#about" className="text-gray-400 hover:text-[#5b7cff] transition-colors">{t.footer.about}</a></li>
              <li><a href="#products" className="text-gray-400 hover:text-[#5b7cff] transition-colors">{t.footer.products}</a></li>
              <li><a href="#contact" className="text-gray-400 hover:text-[#5b7cff] transition-colors">{t.footer.contact}</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 pt-8 text-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} Eternelle System. {t.footer.rights}.</p>
        </div>
      </div>
    </footer>
  );
